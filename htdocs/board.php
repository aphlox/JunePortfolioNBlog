...
?>
<div>
<table><tr><th>번호</th><th>제목</th><th>작성일</th><th>조회수</th></tr>
...
?>
<tr style = "cursor:pointer;" onClick = "location.href='/boardread.php?x=<?php echo $num;?>'"><th><?php echo $num2;?></th><th><?php if(mb_strlen($row['boardtitle'],"utf-8") > 30) {echo $title;} else {echo $title2;}?></th><th><?php echo mb_substr($row['date'],0,11,"utf-8");?></th><th><?php echo $row['hit'];?></th></tr>
<?php $num2++;}?>
</table>
</div>
<div>
