...
function kCalendar(id, date) {
	...
	for(var i = 0; i < week; i++) {
		...
		for(var j = 0; j < 7; j++, dateNum++) {
			...
			var dateNumString = ("0" + dateNum).slice(-2);
			calendar += '	<td onclick="changeDayChart('+currentYear+currentMonthString+dateNumString+')" class="' + dateString[j] + '">' + dateNum + '</td></a>';
		}
		calendar += '	</tr>';
	}
